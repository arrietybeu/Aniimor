-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Lib\\socket\\http.lua
...
local function shouldredirect(reqt, code, headers)
	...
	if reqt.scheme == "https" and scheme ~= "https" then
		return false
	end

	return reqt.redirect ~= false and (code == 301 or code == 302 or code == 303 or code == 307) and (not reqt.method or reqt.method == "GET" or reqt.method == "HEAD") and (reqt.maxredirects == false or (reqt.nredirects or 0) < (reqt.maxredirects or 5))
end
