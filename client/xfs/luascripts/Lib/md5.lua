-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Lib\\md5.lua
...
local function md5_digest(self)
	local msgLen = self.pos
	local padLen = 56 - msgLen % 64
...
function md5.digest(s)
	return md5.new():update(s):digest()
end
