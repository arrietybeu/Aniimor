-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Data\\DialogueGraph\\DialogueGraph_91341916.lua
...
return {
	...
	nodes = {
		...
		},
		{
			kind = 39,
			inputs = {
				maxLockTimeVInput = 10,
				fovBlendTimeVInput = 5,
