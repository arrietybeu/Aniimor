-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Guis\\Panels\\ReplaceSkill\\ReplaceSkillView.lua

local Class = require("Core.Framework.Class")
local UIView = require("Guis.UIView")
local ReplaceSkillView = Class.LightClass("ReplaceSkillView", UIView)

function ReplaceSkillView:findObjects()
...
function ReplaceSkillView:initView()
	self.planBtns = {
		self.tab01UButton,
		self.tab02UButton,
		self.tab03UButton,
