-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Guis\\Panels\\PetSelectionPanelNew\\PetSelectionPanelNewView.lua

local Class = require("Core.Framework.Class")
local UIView = require("Guis.UIView")
local PetSelectionPanelNewView = Class.LightClass("PetSelectionPanelNewView", UIView)

function PetSelectionPanelNewView:findObjects()
	return
end

function PetSelectionPanelNewView:registerObjects()
	...
	self.dialogueBtnNext = self.objectReference:GetRefValue("dailogBtnNext")
...
function PetSelectionPanelNewView:initView()
	return
end

return PetSelectionPanelNewView
