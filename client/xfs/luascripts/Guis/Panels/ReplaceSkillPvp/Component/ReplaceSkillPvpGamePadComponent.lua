-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Guis\\Panels\\ReplaceSkillPvp\\Component\\ReplaceSkillPvpGamePadComponent.lua

local Class = require("Core.Framework.Class")
local TimerManager = require("Core.Timer.TimerManager")
local ResLoader = require("GameApp.ResLoad.ResLoader")
local UIComponent = require("Guis.Helper.UIComponent")
local ReplaceSkillPvpGamePadComponent = Class.LightClass("ReplaceSkillPvpGamePadComponent", UIComponent)
local GamePadNavigation = require("Utils.GamePadNavigation")
local LuaUIUtils = require("Utils.LuaUIUtils")

function ReplaceSkillPvpGamePadComponent:findObjects()
...
function ReplaceSkillPvpGamePadComponent:initView()
...
function ReplaceSkillPvpGamePadComponent:initAreas()
...
function ReplaceSkillPvpGamePadComponent:initKeyAData(rootGameObject)
	return {
		isVirtual = true,
...
function ReplaceSkillPvpGamePadComponent:clonePrefab()
	local curSlot = self.navigation:getCurSlot()
...
function ReplaceSkillPvpGamePadComponent:destroyClonePrefab()
...
function ReplaceSkillPvpGamePadComponent:deSelectLists()
	return
end

function ReplaceSkillPvpGamePadComponent:deSelectOthers()
	return
end

function ReplaceSkillPvpGamePadComponent:deSelectAll()
	self:deSelectLists()
	self:deSelectOthers()
end

function ReplaceSkillPvpGamePadComponent:onInputDeviceChanged(deviceType)
...
function ReplaceSkillPvpGamePadComponent:onDestroy()
	self.root = nil
	self.navigation = nil
...
return ReplaceSkillPvpGamePadComponent
