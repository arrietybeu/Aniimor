-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Entities\\ClientPhotoPetVirtualEntity.lua
...
local ClientPhotoPetVirtualEntity = Class.Class("ClientPhotoPetVirtualEntity", ClientSimpleVirtualEntity)
local ClientVirtualPetComponents = {
	ClientPetAccessoryComponent,
	ClientPhysicsComponent
}

Class.AddComponents(ClientPhotoPetVirtualEntity, ClientVirtualPetComponents)

function ClientPhotoPetVirtualEntity:init(dict)
	ClientPhotoPetVirtualEntity.super.init(self, dict)
...
function ClientPhotoPetVirtualEntity:postInitializeComponents()
	ClientPhotoPetVirtualEntity.super.postInitializeComponents(self)

	self.eModel.isMainAuthority = true
end

function ClientPhotoPetVirtualEntity:isPet()
	return true
end

function ClientPhotoPetVirtualEntity:getConfigData()
...
function ClientPhotoPetVirtualEntity:refreshAppearance()
...
function ClientPhotoPetVirtualEntity:handlerCollision()
...
return ClientPhotoPetVirtualEntity
