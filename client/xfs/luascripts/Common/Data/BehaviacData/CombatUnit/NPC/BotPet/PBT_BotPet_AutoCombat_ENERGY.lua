-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\BehaviacData\\CombatUnit\\NPC\\BotPet\\PBT_BotPet_AutoCombat_ENERGY.lua

local BaseEnum = require("Common.Data.BehaviacData.BaseEnum.BaseEnum")
local Enums = require("Common.AI.Behaviac.Enums")
local PBT_BotPet_AutoCombat_ENERGY = {
	behavior = {
		name = "CombatUnit/NPC/BotPet/PBT_BotPet_AutoCombat_ENERGY",
		version = 322,
		useForRoute = false,
		agenttype = "PetAgent",
		properties = {},
...
return PBT_BotPet_AutoCombat_ENERGY
