-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\BehaviacData\\CombatUnit\\NPC\\BotPet\\PBT_BotPet_AutoCombat_Assist_SUP.lua

local BaseEnum = require("Common.Data.BehaviacData.BaseEnum.BaseEnum")
local Enums = require("Common.AI.Behaviac.Enums")
local PBT_BotPet_AutoCombat_Assist_SUP = {
	behavior = {
		useForRoute = false,
		agenttype = "PetAgent",
		name = "CombatUnit/NPC/BotPet/PBT_BotPet_AutoCombat_Assist_SUP",
		version = 330,
		properties = {},
		pars = {
			{
...
return PBT_BotPet_AutoCombat_Assist_SUP
