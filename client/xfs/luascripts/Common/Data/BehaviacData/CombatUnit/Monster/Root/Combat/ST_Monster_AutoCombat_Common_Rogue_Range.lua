-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\BehaviacData\\CombatUnit\\Monster\\Root\\Combat\\ST_Monster_AutoCombat_Common_Rogue_Range.lua

local BaseEnum = require("Common.Data.BehaviacData.BaseEnum.BaseEnum")
local Enums = require("Common.AI.Behaviac.Enums")
local ST_Monster_AutoCombat_Common_Rogue_Range = {
	behavior = {
		version = 117,
		name = "CombatUnit/Monster/Root/Combat/ST_Monster_AutoCombat_Common_Rogue_Range",
...
return ST_Monster_AutoCombat_Common_Rogue_Range
