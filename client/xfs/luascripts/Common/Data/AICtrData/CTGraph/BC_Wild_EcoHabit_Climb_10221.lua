-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_EcoHabit_Climb_10221.lua
...
function _M.executeEndTrigger(flow)
	...
	local _2 = _C(28, "GetSelfId", flow)

	_A(flow, "StopEffectOnTarget", _2, "Eff_Parmon_10221_Skill_EleField_01")
...
function _M._to_4_0(flow)
	...
	local _2 = _C(27, "GetSelfId", flow)

	_A(flow, "PlayEffectOnTarget", _2, "Eff_Parmon_10221_Skill_EleField_01", 30)
...
function _M._get_13_2(flow)
	local _0 = _C(9, "GetAoiResPointPortTableByLevel", flow, 0, 10, 2, {
		"TR_EcoHabit_Climb"
	}, {
		"TR_EcoHabit_Climb"
	})
...
function _M._get_29_1(flow)
	...
	return _C(29, "GetClimbDataIdFromResPoint", flow, _0)
end
