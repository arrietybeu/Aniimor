-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_10471_fire.lua
...
function _M._to_20_0(flow)
	...
	if not _1 then
		flow:setActive()
		_C(20, "DoBehaviour", flow, "PBT_CustomLoopAnimation")
		flow.__agent:clearSubTreeLocalParams()
...
function _M._get_23_2(flow)
	...
	local _0 = _C(25, "CheckHasChemState", flow, _4, "STATE_AFLAME_KEY")
	...
	local _3 = _C(22, "GetDistance", flow, _2, 0, false)
	local _1 = _3 <= 10
