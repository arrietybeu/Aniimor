-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_PER_Leave_ToPlayer.lua
...
function _M.executeEventTrigger(flow, eventName)
	if eventName == "Event_PER_Leave" then
...
function _M._to_12_0(flow)
	...
	if not _1 then
		flow:setActive()
		_C(12, "DoBehaviour", flow, "PBT_Perception_Leave")
...
function _M._to_17_0(flow)
	flow:setActive()
	_A(flow, "SendMessageToTrigger", 0, 1013)
