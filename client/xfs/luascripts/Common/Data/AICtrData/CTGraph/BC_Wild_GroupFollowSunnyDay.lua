-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_GroupFollowSunnyDay.lua
...
function _M._get_31_2(flow)
	local _2 = _C(26, "GetDayTime", flow)
	...
	local _3 = _C(29, "GetSelfId", flow)
	local _4 = _C(28, "GetCurWeatherId", flow, _3)
	local _1 = _4 == 1
