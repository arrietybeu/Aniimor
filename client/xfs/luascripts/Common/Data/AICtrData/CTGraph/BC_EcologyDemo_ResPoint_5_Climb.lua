-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_EcologyDemo_ResPoint_5_Climb.lua
...
function _M._get_13_2(flow)
	local _0 = _C(9, "GetAoiResPointPortTableByLevel", flow, 0, 10, 0, {
		"TR_EcoDemoTest_Climb"
	}, {
		"TR_EcoDemoTest_Climb"
	})
...
function _M._get_19_1(flow)
	...
	return _C(19, "GetClimbDataIdFromResPoint", flow, _0)
end
