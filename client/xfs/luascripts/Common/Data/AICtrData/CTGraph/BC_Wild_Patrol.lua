-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_Patrol.lua
...
function _M._get_76_1(flow)
	local _1 = _M._get_84_1(flow)
	local _0 = _C(91, "CheckRouteIdIsValidSimple", flow, _1, 0)
...
function _M._get_90_1(flow)
	return _C(90, "GetRouteIdFromEntitySimple", flow, 0)
end
