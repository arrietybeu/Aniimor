-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Recruit_FollowOneByOne_10051.lua
...
function _M._to_9_0(flow)
	...
	_C(9, "DoAction", flow, "SendMessageToTrigger", _0, 1001)
...
function _M._to_23_0(flow)
	flow:setActive()
	_C(23, "DoAction", flow, "SendMessageToTrigger", 0, 1005101)
...
function _M._get_22_2(flow)
	...
	return _C(22, "IsEqual", flow, _0, 1005200)
end
