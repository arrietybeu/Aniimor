-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Burrow_Maku_2.lua
...
function _M._to_172_0(flow)
	...
	local _0 = _M._get_170_1(flow)

	return _doBehaviourTail_0(flow, 172, _0, 0, 30, true, 6, 99999, 0, 0, false, false)
end
...
function _M._get_117_2(flow)
	...
	local _3 = _C(114, "SelectOneByRandom", flow, _2)
	local _4 = _M._get_168_1(flow)
	local _5 = _C(123, "GetDistance", flow, _3, _4, false)
	local _6 = _M._get_168_1(flow)
	local _7 = _M._get_140_1(flow)
	local _8 = _C(142, "GetDistance", flow, _6, _7, false)
	local _0 = _5 <= _8
	...
	local _10 = _M._get_174_2(flow)
	local _11 = _C(175, "SelectOneByRandom", flow, _10)
	local _12 = _C(176, "GetDistance", flow, _9, _11, false)
	local _1 = _12 <= 7.6
...
function _M._get_151_2(flow)
	...
	return _C(151, "HasEntityTag", flow, _0, "TE_Env_Leave_Maku2_2")
end

function _M._get_168_1(flow)
	local _0 = _C(131, "GetAoiEntityTableByLevel", flow, 0, 50, 2)

	return _C(168, "SelectOneByRandom", flow, _0)
end

function _M._get_169_2(flow)
	local _0 = _C(171, "GetAoiEntityTableByLevel", flow, 0, 50, 256)
	...
	for k, v in ipairs(_0) do
		...
		flow:setCache(169, "__iterItem", _2 and _2.actorId or 0)

		if _M._get_173_2(flow) then
			_1[#_1 + 1] = _2.actorId
		end
	end
...
function _M._get_170_1(flow)
	local _0 = _M._get_169_2(flow)

	return _C(170, "SelectOneByRandom", flow, _0)
end

function _M._get_173_2(flow)
	local _0 = flow:getCache(169, "__iterItem")

	return _C(173, "HasEntityTag", flow, _0, "TE_Env_Leave_Maku2_3")
end

function _M._get_174_2(flow)
	local _0 = _C(178, "GetAoiEntityTableByLevel", flow, 0, 50, 256)
	...
	for k, v in ipairs(_0) do
		...
		flow:setCache(174, "__iterItem", _2 and _2.actorId or 0)
...
function _M._get_179_2(flow)
	local _0 = flow:getCache(174, "__iterItem")

	return _C(179, "HasEntityTag", flow, _0, "TE_Env_Leave_Maku_Center")
end
