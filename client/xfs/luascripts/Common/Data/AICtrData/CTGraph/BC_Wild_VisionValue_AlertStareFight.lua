-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_VisionValue_AlertStareFight.lua
...
function _M._to_48_0(flow)
	...
	flow.__agent:addSubTreeLocalParam("tMaxTime", 3000)
...
function _M._to_61_0(flow)
	...
	local _0 = _C(63, "GetSelfId", flow)
	local _1 = flow:getMessageContext()

	_1.sourceActorId = flow.__actorId

	flow:sendMessage(_0, "VisionValue_ReadyToFight", _1)
...
function _M._get_56_1(flow)
	local _0 = _C(55, "GetPerceptibilityTable", flow)
