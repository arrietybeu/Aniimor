-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_GroupBehav_Flash.lua
...
function _M._to_149_0(flow)
	...
	return _doBehaviourTail_0(flow, 149, 0, "Behav_Alert", 2, "Alert", 0, "", false, false, false)
end
...
function _M._to_150_0(flow)
	...
	return _doBehaviourTail_0(flow, 150, 0, "Attack03", 2, "", 0, "", false, false, false)
end
...
function _M._to_151_0(flow)
	...
	return _doBehaviourTail_0(flow, 151, 0, "Attack02", 2, "Angry", 1, "", false, false, false)
end
...
function _M._to_153_0(flow)
	...
	return _doBehaviourTail_0(flow, 153, 0, "Attack03", 2, "Angry", 1, "", false, false, false)
end
...
function _M._to_154_0(flow)
	...
	return _doBehaviourTail_0(flow, 154, 0, "Hit_L", 2, "", 0, "", false, false, false)
end
...
function _M._to_155_0(flow)
	...
	return _doBehaviourTail_0(flow, 155, 0, "Behav_Cry", 3, "Cry", 3, "", false, false, false)
end
...
function _M._to_156_0(flow)
	...
	return _doBehaviourTail_0(flow, 156, 0, "Behav_Happy", 3, "Happy", 3, "", false, false, false)
end
...
function _M._to_158_0(flow)
	...
	return _doBehaviourTail_0(flow, 158, 3, "Hit_H", 2, "", 0, "", false, false, false)
end
