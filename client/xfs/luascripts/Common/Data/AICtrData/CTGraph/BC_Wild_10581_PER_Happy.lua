-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_10581_PER_Happy.lua
...
function _M._to_59_0(flow)
	...
	if _0 then
		flow:setActive()
		_C(59, "DoAction", flow, "SendMessageToTrigger", 0, 1058101)
...
function _M._get_71_2(flow)
	...
	return _C(71, "GetPetData", flow, _0, "baseFormPet", true, 0)
end

function _M._get_72_2(flow)
	local _0 = _M._get_71_2(flow)

	return _C(72, "IsEqual", flow, _0, 1004500)
end
