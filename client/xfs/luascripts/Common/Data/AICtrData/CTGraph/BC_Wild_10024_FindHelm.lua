-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_10024_FindHelm.lua
...
function _M._to_94_0(flow)
	...
	return _doBehaviourTail_1(flow, 94, 0, "AI_IdleSpecial01", 1.2, "", 0, "", false, false, false)
end
...
function _M._to_101_0(flow)
	...
	return _doBehaviourTail_1(flow, 101, 0, "AI_IdleSpecial01", 5, "0", 0, "", false, true, false)
end
...
function _M._to_102_0(flow)
	...
	return _doBehaviourTail_2(flow, 102, "Proud", 2)
end
...
function _M._to_108_0(flow)
	...
	return _doBehaviourTail_1(flow, 108, 0, "JumpBack", 1.5, "", 0, "", false, false, false)
end
...
function _M._to_109_0(flow)
	...
	return _doBehaviourTail_2(flow, 109, "Proud", 2)
end
