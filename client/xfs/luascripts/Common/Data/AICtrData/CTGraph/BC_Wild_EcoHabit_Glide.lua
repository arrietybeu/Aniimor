-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_EcoHabit_Glide.lua
...
function _M._get_22_1(flow)
	...
	return _C(22, "GetRouteIdFromResPoint", flow, false, _0)
end

function _M._get_23_3(flow)
	local _0 = _C(9, "GetAoiResPointPortTableByLevel", flow, 0, 30, 2, {
		"TR_EcoHabit_Glide"
	}, {
		"TR_EcoHabit_Glide"
	})
...
function _M._get_26_2(flow)
	...
	local _0 = _C(25, "GetDistanceFromEntityToResPointPort", flow, 0, _1)
...
function _M._get_34_2(flow)
	...
	return _C(34, "GetDistanceFromEntityToResPointPort", flow, 0, _0)
end
