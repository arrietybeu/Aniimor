-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Pet_10261_Habit_Cry_Msg.lua
...
function _M.executeEventTrigger(flow, eventName)
	if eventName == "LevelMsgTrigger10261_Habit_Cry" then
...
function _M.executeEndTrigger(flow)
	...
	_A(flow, "StopEffectOnTarget", _0, "Eff_Env_Level_IOT_Meadow_Sadclouds_Gather")
	flow:setActive()

	local _1 = _M._get_9_0(flow)

	_A(flow, "StopEffectOnTarget", _1, "Eff_Env_Level_IOT_Meadow_Sadclouds_Looping")
	flow:setActive()

	local _2 = _M._get_9_0(flow)

	_A(flow, "StopEffectOnTarget", _2, "Eff_Env_Level_IOT_Meadow_Sadclouds_Disappear_01")
...
function _M._to_2_0(flow)
	...
	return _doBehaviourTail_0(flow, 2, "Eff_Env_Level_IOT_Meadow_Sadclouds_Gather", _0)
end
...
function _M._to_3_0(flow)
	...
	return _doBehaviourTail_0(flow, 3, "Eff_Env_Level_IOT_Meadow_Sadclouds_Looping", _0)
end
...
function _M._to_4_0(flow)
	...
	return _doBehaviourTail_0(flow, 4, "Eff_Env_Level_IOT_Meadow_Sadclouds_Disappear_01", _0)
end
