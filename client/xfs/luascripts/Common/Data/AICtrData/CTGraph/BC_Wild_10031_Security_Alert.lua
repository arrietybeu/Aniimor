-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_10031_Security_Alert.lua
...
function _M.executeMessageTrigger(flow, eventName)
	if eventName == "VisionValue_Full" then
		flow:setActive()
		_A(flow, "TriggerBluePrint", "GLS_10031FoundPlayer")
		flow:setActive()
		_A(flow, "TriggerBluePrint", "GLS_10031FoundPlayer")
		flow:setActive()
