-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_GroupBehav_SingInTheStone_MakeGroup.lua
...
function _M._get_1_3(flow)
	return _C(1, "GetAoiResPointPortTableByLevel", flow, 0, 30, 2, {
		"TR_GB_SingInTheStone"
	}, nil)
end

function _M._get_5_2(flow)
	local _2 = _C(9, "IsInGroupBehaviour", flow, 0, true, "GBP_Wild_DanceSing")
	local _0 = not _2
