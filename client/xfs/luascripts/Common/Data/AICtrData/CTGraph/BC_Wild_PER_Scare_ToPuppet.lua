-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_PER_Scare_ToPuppet.lua
...
function _M._to_16_0(flow)
	if not _B(flow, "PBT_Behav_Com_Scare") then
		return
	end
