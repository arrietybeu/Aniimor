-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_10451_GuGuSisyphus_Rain_Suc.lua
...
function _M.executeEventTrigger(flow, eventName)
	if eventName == "LevelMsgTriggerBC_Wild_10451_GuGuSisyphus_Rain_Suc" then
...
function _M._to_124_0(flow)
	flow:addTimer(5, _M, "_to_127_0", flow)
...
function _M._to_126_0(flow)
	flow:addTimer(10, _M, "_to_128_0", flow)
