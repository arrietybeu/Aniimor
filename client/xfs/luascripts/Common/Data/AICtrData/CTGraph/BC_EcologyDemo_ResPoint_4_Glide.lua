-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_EcologyDemo_ResPoint_4_Glide.lua
...
function _M._get_13_2(flow)
	local _0 = _C(9, "GetAoiResPointPortTableByLevel", flow, 0, 50, 0, {
		"TR_EcoDemoTest_Glide"
	}, {
		"TR_EcoDemoTest_Glide"
	})
...
function _M._get_18_1(flow)
	...
	return _C(18, "GetRouteIdFromResPoint", flow, false, _0)
end
