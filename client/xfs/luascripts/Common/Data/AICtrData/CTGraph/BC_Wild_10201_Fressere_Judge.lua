-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_10201_Fressere_Judge.lua
...
function _M._to_224_0(flow)
	local _1 = _C(226, "HasAITag", flow, 0, "Cry")
	local _0 = not _1
...
function _M._get_138_2(flow)
	...
	local _0 = _C(125, "HasEntityTag", flow, _2, "TE_Chest_BacillusMycoidesRuber")
	...
	local _4 = _C(131, "GetDistance", flow, _3, 0, true)
	local _1 = _4 <= 0.6
...
function _M._get_143_2(flow)
	...
	local _0 = _C(144, "HasEntityTag", flow, _2, "TE_Chest_BacillusMycoidesRuber")
	...
	local _3 = _C(148, "GetDistance", flow, _4, 0, true)
	local _1 = _3 <= 15
...
function _M._get_259_2(flow)
	return _C(259, "HasAITag", flow, 0, "EatBreak")
end
