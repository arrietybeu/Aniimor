-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_10052_Fight.lua
...
function _M._get_59_3(flow)
	local _4 = _M._get_63_2(flow)
	local _3 = _C(39, "GetPetData", flow, _4, "petPrototypeId", true, 0)
	local _0 = _3 == 1005200
	...
	local _7 = _M._get_63_2(flow)
	local _1 = _C(62, "IsCurCombatPet", flow, _7)

	if not _1 then
		return false
	end

	local _5 = _M._get_63_2(flow)
	local _6 = _C(57, "GetDistance", flow, _5, 0, false)
	local _2 = _6 <= 12
...
function _M._get_63_2(flow)
	return flow:getCache(63, "__iterItem")
end
