-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_GroupBehav_Test_HitHeadInTurns.lua
...
function _M._to_23_0(flow)
	...
	return _doBehaviourTail_0(flow, 23, 0, "EnvBehav_HitHead", 5, "", 5, "", false, false, false)
end
...
function _M._to_24_0(flow)
	...
	return _doBehaviourTail_0(flow, 24, 0, "EnvBehav_HeadBeHit", 5, "", 5, "", false, false, false)
end
