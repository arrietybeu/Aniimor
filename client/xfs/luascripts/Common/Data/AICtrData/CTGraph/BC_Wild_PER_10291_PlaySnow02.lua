-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_PER_10291_PlaySnow02.lua
...
function _M._to_50_0(flow)
	...
	local _1 = _M.checkInterrupt(flow, 50)

	if _0 and not _1 then
		flow:setActive()
		_C(50, "DoBehaviour", flow, "PBT_CustomLoopAnimation")
		flow.__agent:clearSubTreeLocalParams()
...
function _M._to_51_0(flow)
	...
	if not _1 then
		flow:setActive()
		_C(51, "DoBehaviour", flow, "PBT_MoveToTargetEntity")
...
function _M._get_13_2(flow)
	...
	local _0 = _C(12, "HasEntityTag", flow, _2, "TE_Env_10024_KickStone")
