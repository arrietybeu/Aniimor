-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_10023_FindHelm.lua
...
function _M._to_80_0(flow)
	...
	if _0 then
		...
		local _7 = _C(111, "GetSelfId", flow)

		_A(flow, "PlayEffectOnTarget", _7, "Eff_Common_Behav_Doubt", 1.5)
...
function _M._to_113_0(flow)
	...
	return _doBehaviourTail_1(flow, 113, 0, "Behav_Angry", 0, "", 0, "", false, true, false)
end
...
function _M._to_114_0(flow)
	...
	return _doBehaviourTail_1(flow, 114, 0, "Behav_Angry", 0, "", 0, "", false, true, false)
end
