-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_10031_VisionValue_Trigger_3State.lua
...
function _M._to_50_0(flow)
	...
	local _1 = _M._get_98_3(flow)

	if _1 then
		flow:setActive()

		local _6 = _M._get_63_0(flow)
		local _7 = flow:getMessageContext()
		local _8 = _M._get_48_1(flow)

		_7.sensorTgtId = _8
		_7.sourceActorId = flow.__actorId

		flow:sendMessage(_6, "VisionValue_Full", _7)
	...
	if _3 then
		...
		local _9 = _M._get_63_0(flow)
		local _10 = flow:getMessageContext()

		_10.sourceActorId = flow.__actorId

		flow:sendMessage(_9, "VisionValue_None", _10)
...
function _M._to_187_0(flow)
	...
	if _0 then
		...
		local _1 = _C(188, "GetSelfId", flow)
		local _2 = flow:getMessageContext()
		local _4 = _M._get_182_2(flow)
		local _3 = _C(189, "GetPetMaster", flow, _4)

		_2.sensorTgtId = _3
		_2.sourceActorId = flow.__actorId

		flow:sendMessage(_1, "VisionValue_Full", _2)
...
function _M._get_52_3(flow)
	local _3 = _C(91, "HasAITag", flow, 0, "TA_VisionAlert", "TA_VisionFull")
	local _0 = not _3
	...
	local _4 = _C(177, "GetSelfId", flow)
	local _5 = _C(176, "GetTargetBuffLayerCount", flow, _4, 2103213)
	local _2 = _5 == 0
...
function _M._get_98_3(flow)
	...
	local _4 = _C(142, "HasAITag", flow, 0, "TA_VisionFull")
	local _1 = not _4
	...
	local _5 = _C(179, "GetSelfId", flow)
	local _6 = _C(180, "GetTargetBuffLayerCount", flow, _5, 2103213)
	local _2 = _6 == 0
