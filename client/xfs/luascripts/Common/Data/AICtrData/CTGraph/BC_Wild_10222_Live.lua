-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_10222_Live.lua
...
function _M._to_61_0(flow)
	...
	flow.__agent:addSubTreeLocalParam("tTimeout", 20)
...
function _M._to_77_0(flow)
	if not _B(flow, "PBT_10222Live") then
		return
	end

	flow.__agent:clearSubTreeLocalParams()
	flow.__agent:addSubTreeLocalParam("happyTimeOut", 10)
	flow:setContinue(77)
...
function _M._get_71_2(flow)
	local _0 = _C(62, "GetAoiResPointPortTableByLevel", flow, 0, 50, 0, {
		"TR_ElectricMarten"
	}, {
		"TR_ElectricMarten"
	})
