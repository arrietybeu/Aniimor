-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_10443_PER_StareFriendly.lua
...
function _M._to_10_0(flow)
	...
	if not _1 then
		flow:setActive()
		_C(10, "DoBehaviour", flow, "PBT_10443_TurnAndCustomAnimation")
		...
		flow.__agent:addSubTreeLocalParam("tAnimationTimeout", 7.5)
...
function _M._to_20_0(flow)
	...
	if _0 then
		...
		local _1 = _C(24, "GetSelfId", flow)
		local _2 = _M._get_0_2(flow)

		_A(flow, "SendMessageToTriggerSpecial", _1, _2)
...
function _M._to_21_0(flow)
	flow:addTimer(3, _M, "_to_20_0", flow)
...
function _M._get_23_2(flow)
	local _2 = _M._get_0_2(flow)
	local _3 = _C(16, "GetDistance", flow, _2, 0, false)
	local _0 = _3 > 10
