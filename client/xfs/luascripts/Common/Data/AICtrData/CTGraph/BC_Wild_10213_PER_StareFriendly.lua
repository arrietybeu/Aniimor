-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_10213_PER_StareFriendly.lua
...
function _M._to_84_0(flow)
	flow:addTimer(1, _M, "_to_90_0", flow)
...
function _M._to_90_0(flow)
	...
	if _0 then
		flow:setActive()
		_A(flow, "SendMessageToTrigger", 0, 1021301)
...
function _M._to_91_0(flow)
	...
	local _1 = _M.checkInterrupt(flow, 91)

	if not _1 then
		flow:setActive()
		_C(91, "DoBehaviour", flow, "PBT_CustomLoopAnimation")
		flow.__agent:clearSubTreeLocalParams()
