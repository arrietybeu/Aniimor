-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_EcoDemo_Node_1_ChemState_CE.lua
...
function _M._get_18_1(flow)
	local _0 = flow:getCache(19, "__iterItem")

	return _C(18, "CheckHasChemState", flow, _0, nil)
end

function _M._get_19_2(flow)
	local _0 = _C(17, "GetAoiEntityTableByLevel", flow, 0, 10, 256)
