-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_GroupBehav_DanceSing.lua
...
function _M._get_51_1(flow)
	...
	return _C(51, "GetRouteIdFromResPoint", flow, true, _0, 3)
end
...
function _M._get_56_1(flow)
	...
	return _C(56, "GetRouteIdFromResPoint", flow, true, _0, 4)
end

function _M._get_74_1(flow)
	local _0 = flow:getContextValue("tPointId")

	return _C(74, "GetRouteIdFromResPoint", flow, true, _0, 1)
end
