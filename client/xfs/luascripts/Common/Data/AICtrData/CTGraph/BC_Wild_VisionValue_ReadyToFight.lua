-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Wild_VisionValue_ReadyToFight.lua
...
function _M.executeMessageTrigger(flow, eventName)
	if eventName == "VisionValue_ReadyToFight" then
...
function _M._get_59_1(flow)
	local _0 = _C(58, "GetPerceptibilityTable", flow)
