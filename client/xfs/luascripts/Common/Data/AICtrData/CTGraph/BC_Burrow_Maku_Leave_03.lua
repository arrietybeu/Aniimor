-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\Data\\AICtrData\\CTGraph\\BC_Burrow_Maku_Leave_03.lua
...
function _M._get_15_2(flow)
	...
	return _C(15, "HasEntityTag", flow, _0, "TE_Env_Leave_Maku_Mark_C")
end
...
function _M._get_64_2(flow)
	local _1 = _C(62, "GetAoiEntityTableByLevel", flow, 0, 50, 2)
	local _2 = _C(60, "SelectOneByRandom", flow, _1)
	local _3 = _M._get_59_2(flow)
	local _4 = _C(61, "SelectOneByRandom", flow, _3)
	local _0 = _C(63, "GetDistance", flow, _2, _4, false)
