-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\AI\\Behaviac\\Node\\Actions\\Wait.lua
...
local Wait = functions.class("Wait", Leaf)

macros.ADD_BEHAVIAC_DYNAMIC_TYPE("Wait", Wait)
macros.BEHAVIAC_DECLARE_DYNAMIC_TYPE("Wait", "Leaf")
