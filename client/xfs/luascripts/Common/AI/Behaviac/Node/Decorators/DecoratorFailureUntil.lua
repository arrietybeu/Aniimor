-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\AI\\Behaviac\\Node\\Decorators\\DecoratorFailureUntil.lua
...
local DecoratorFailureUntil = functions.class("DecoratorFailureUntil", DecoratorCount)

macros.ADD_BEHAVIAC_DYNAMIC_TYPE("DecoratorFailureUntil", DecoratorFailureUntil)
macros.BEHAVIAC_DECLARE_DYNAMIC_TYPE("DecoratorFailureUntil", "DecoratorCount")
