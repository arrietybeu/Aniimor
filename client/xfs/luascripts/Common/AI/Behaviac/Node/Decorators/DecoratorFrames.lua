-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\AI\\Behaviac\\Node\\Decorators\\DecoratorFrames.lua
...
local DecoratorFrames = functions.class("DecoratorFrames", Decorator)

macros.ADD_BEHAVIAC_DYNAMIC_TYPE("DecoratorFrames", DecoratorFrames)
macros.BEHAVIAC_DECLARE_DYNAMIC_TYPE("DecoratorFrames", "Decorator")
