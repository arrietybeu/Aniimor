-- chunkname: @C:\\dev\\jkroot\\ws\\workspace\\XWinPublish\\proj\\p4dir\\client\\LuaScripts\\Common\\AI\\Behaviac\\Node\\Composites\\SelectorStochastic.lua
...
local SelectorStochastic = functions.class("SelectorStochastic", CompositeStochastic)

macros.ADD_BEHAVIAC_DYNAMIC_TYPE("SelectorStochastic", SelectorStochastic)
macros.BEHAVIAC_DECLARE_DYNAMIC_TYPE("SelectorStochastic", "CompositeStochastic")
